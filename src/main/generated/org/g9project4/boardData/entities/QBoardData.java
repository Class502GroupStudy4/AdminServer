...
public class QBoardData extends EntityPathBase<BoardData> {
    ...
    private static final long serialVersionUID = -1682214152L;
    ...
    public final org.g9project4.board.entities.QBoard board;
    ...
    public QBoardData(Class<? extends BoardData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.board = inits.isInitialized("board") ? new org.g9project4.board.entities.QBoard(forProperty("board")) : null;
